...
<html lang="en">
    ...
    <h2>Use case:</h2>
    <p>The user's objective on this page is to fill the screens of their "cineplex" with the movies of their choice, while remaining under budget. Their ultimate goal is to accumulate more "box office wealth" than those they are playing against.</p>
    <p>From the get-go, the user can see the name of their cineplex along the top of the screen. Adjacent to this are meters indicating the user's total box office commissions and where that ranks among other users during the current season. Directly below this is a bar which informs the user of 4 things:</p>
    <ul>
