...
<html lang="en">
    ...
    <hr>
    <h2>Persona:</h2>
    <p>The core user of Fantasy Movie League is a cinephile. Not merely a movie buff, this person has an eccentricity for the internal workings of the film industry, particularly the financial aspects. Because of the heavy use of numbers, this user is probably an adult. The user is someone with highly disposable time and a competitive nature.</p>
    <h2>Use case:</h2>
    ...
    <p>The user may wish to revoke their decision to select a movie. To do so, they need only to hover over the chosen movie poster in its Screen Slot. This creates a clickable message, "REMOVE". If the user clicks this, then that movie will be removed the screen. The movie placed in the Screen Slot with the next highest number will then appear in the recently vacated Screen Slot. </p>
    </body>
</html>